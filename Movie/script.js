...
function renderMovies(moviesToDisplay) {
    ...
    moviesToDisplay.forEach(movie => {
        ...
        info.innerHTML = `<strong>${escapeHtml(movie.title)}</strong> (${movie.year}) - ${escapeHtml(movie.genre)}`;
...
function fetchMovies() {
    fetch(API_URL)
        ...
        .catch(err => {
            ...
            movieListDiv.innerHTML = '<p style="color:salmon">Could not load movies. Check console and ensure JSON Server is running.</p>';
        });
}
